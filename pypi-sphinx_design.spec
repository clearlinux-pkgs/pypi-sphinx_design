...
Source0  : https://files.pythonhosted.org/packages/2b/69/b34e0cb5336f09c6866d53b4a19d76c227cdec1bbc7ac4de63ca7d58c9c7/sphinx_design-0.6.1.tar.gz
...
%prep
%setup -q -n sphinx_design-0.6.1
cd %{_builddir}/sphinx_design-0.6.1
pushd ..
cp -a sphinx_design-0.6.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1722619964
