...
Source0  : https://files.pythonhosted.org/packages/ec/2b/fdcfecad13079cc5c620b9ed380dc4b29f02cff69a1189057da0909e25ef/sphinx_design-0.6.0.tar.gz
...
%prep
%setup -q -n sphinx_design-0.6.0
cd %{_builddir}/sphinx_design-0.6.0
pushd ..
cp -a sphinx_design-0.6.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1716483013
...
cp %{_builddir}/sphinx_design-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/pypi-sphinx_design/c95a94e648d97c106f90e057bbed73bd54742ea8 || :
...
cp %{_builddir}/sphinx_design-%{version}/sphinx_design/compiled/octicon_LICENSE %{buildroot}/usr/share/package-licenses/pypi-sphinx_design/8fe934ffb827bdadb8e8f49e121fa53b833c238d || :
...
/usr/share/package-licenses/pypi-sphinx_design/8fe934ffb827bdadb8e8f49e121fa53b833c238d
/usr/share/package-licenses/pypi-sphinx_design/c95a94e648d97c106f90e057bbed73bd54742ea8
