...
Source0  : https://files.pythonhosted.org/packages/7b/28/0eb39f87239acf377db5f08cf2f2b27d43c3371624a4cca128dfe952aa10/sphinx_design-0.3.0.tar.gz
...
%prep
%setup -q -n sphinx_design-0.3.0
cd %{_builddir}/sphinx_design-0.3.0
pushd ..
cp -a sphinx_design-0.3.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661211305
